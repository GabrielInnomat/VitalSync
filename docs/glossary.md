...
> Terms marked **(Building Block)** refer to concrete types or concepts in `BuildingBlocks.Domain`. See the [BuildingBlocks.Domain technical reference](../BuildingBlocks/docs/architecture/building-blocks-domain.md) for details.
...
| Term                      | Definition                                                                                                                                                                                                                                  |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Building Blocks**       | A reusable platform of shared concepts and components (Domain, Application, Infrastructure, Persistence, Event Processing, Common) that underpins the microservices without coupling them to VitalSync, and is reusable in future projects. |
