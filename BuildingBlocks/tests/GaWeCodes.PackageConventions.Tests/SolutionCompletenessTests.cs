...
/// <summary>
/// Keeps BuildingBlocks.slnx in step with the projects that actually exist.
/// </summary>
/// <remarks>
...
public sealed class SolutionCompletenessTests
{
    ...
    [
        .. XDocument.Load(Path.Combine(root, "BuildingBlocks.slnx"))
            .Descendants("Project")
