...
public sealed class ArchitectureTests
{
    ...
    public void Domain_HasNoBuildingBlockOrInfrastructurePackageReferences()
    {
        ...
        Assert.DoesNotContain(references, name => name.StartsWith("GaWeCodes", StringComparison.Ordinal));
    ...
    public void Infrastructure_ReferencesBothApplicationAndDomain()
    {
        ...
        Assert.Contains("GaWeCodes.Application", references);
        Assert.Contains("GaWeCodes.Domain", references);
    }
    ...
    {
        var packages = ResolvedPackages("src/GaWeCodes.Domain");
    ...
    {
        var packages = ResolvedPackages("src/GaWeCodes.Application");
