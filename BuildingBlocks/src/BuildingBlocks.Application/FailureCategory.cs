...
/// <summary>
/// Classifies an <see cref="Failure"/> by the kind of expected failure it represents.
/// </summary>
/// <remarks>
...
/// deliberately no <c>Unexpected</c> value &#8212; unexpected failures remain exceptions handled globally rather than becoming a
/// <see cref="Result"/> (see ADR-0017).
/// </remarks>
public enum FailureCategory
{
    /// <summary>
    /// A structural validation failure, translated from a <see cref="BuildingBlocks.Domain.DomainValidationException" />.
    /// </summary>
    Validation,

    /// <summary>
    /// A broken domain invariant, translated from a <see cref="BuildingBlocks.Domain.BusinessRuleViolationException"/>.
    /// </summary>
    BusinessRule,
