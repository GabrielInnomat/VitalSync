...
/// Behaviors run in an explicit numeric order (lower orders wrap further out); the built-in behaviors occupy fixed
/// slots and hosts add their own via <c>BuildingBlocksOptions.AddPipelineBehavior</c>.
/// </remarks>
